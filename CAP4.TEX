...
\section{Análisis del conjunto de Imágenes}
	...
	\subsection{Proceso de Aumento de Datos (Data Augmentation)}
		...
		\item[3)] Rotación
		\item[4)] Zoom (Out/In)
		\item[5)] Ecualización de Histrogama
		\vskip 3cm
		\end{enumerate} 
