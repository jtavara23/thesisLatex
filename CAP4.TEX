...
\section{Variables de la Investigación}
	...
	\section{Indicadores}
		...
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Tasa de Sensibilidad\\ o Recall\end{tabular}} & \multirow{2}{*}{$S= \frac{Verdaderos\,Positivos}{{Verdaderos\,Positivos}+{Falsos\,Negativos}}x100$} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Modelo de\\ Reconocimiento\end{tabular}} \\
		 &  &  \\ \hline
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Tasa de\\ Error\end{tabular}} & \multirow{2}{*}{$S= \frac{Falsos\,Negativos}{{Verdaderos\,Positivos}+{Falsos\,Negativos}}x100$} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Modelo de\\ Reconocimiento\end{tabular}} \\
		 &  &  \\ \hline
	...
	\section{Recolección de Datos para la Construcción del Modelo}
		...
		\item[A)] {\bf Arquitectura AlexNet}  \vskip 0.2cm
		...
		\item[B)] {\bf Arquitectura Inception}  \vskip 0.2cm
	...
	\section{Recolección de Datos para el Entrenamiento y Evaluación del Modelo}
		...
		\item[B)] {\bf Señales de Tránsito de Perú} \newline
