...
\section{Análisis del conjunto de Imágenes}
	...
	\subsection{Datos Iniciales para el entrenamiento}
		...
		\subsubsection{Señales de Tránsito de Alemania}
			...
			\begin{figure}[H]
				\begin{center}
				\includegraphics[width=1\textwidth, height=1.3\textheight,keepaspectratio]{images/desarrollo/histograms/initial39209}
				\end{center}
				\begin{center}
	...
	\subsection{Datos para la evaluación}
	...
	\subsection{Dataset final para el Entrenamiento}
		...
		\subsubsection{Señales de Tránsito de Alemania - Dataset Balanceado }
			...
			Teniendo en cuenta lo descrito en la \textbf{Sección 2.3.4 (Validación Cruzada)}, para la etapa del entrenamiento, el conjunto de datos Balanceados compuesto por 270900 imágenes fue dividido en un subconjunto de entrenamiento y otro para validación, con la siguiente distribución:
			\vspace{1.5em}
			\begin{table}[H]
...
\section{Arquitectura del Modelo}
	...
	Los hiperparámetros engloban funciones, variables y constantes utilizadas durante la construcción de las diferentes arquitecturas; estas varían, sin embargo, siguiendo conceptos teóricos, antecedentes (investigaciones previas) y sobre todo después de algunas pruebas realizadas, los siguientes hiperparámetros fueron seleccionados de manera específica:
		...
		\begin{table}[H]
			...
			{\textbf{Tasa de Aprendizaje - Dataset Alemania}}                     		& {\textit{0.0005 (5e-4)}}  				  &
			\textbf{Tasa de Aprendizaje - Dataset Perú}                                & \textit{0.0001 (1e-4)}                    \\ \hline
	...
	Estos 5 modelos son descritos a continuación.
		...
		\subsubsection{Diseño A} 
			...
			\item \underline{Dataset de Alemania}			
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño A (19'057 952 neuronas) - Dataset de Imágenes de Alemania}}
			...
			\item \underline{Dataset del Perú}
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño A (66'428 192 neuronas) - Dataset de Imágenes de Perú}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
		...
		Diseño compuesto de 3 capas convolucionales y 2 capas totalmente conectadas.
			...
			\item \underline{Dataset de Alemania}		
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño B (3'970 336 neuronas) - Dataset de Imágenes de Alemania}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
			...
			\item \underline{Dataset del Perú}
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño B (29'910 388 neuronas) - Dataset de Imágenes de Perú}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
		...
		\subsubsection{Diseño C} %model4
			...
			\item \underline{Dataset de Alemania} 	
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño C (3'937 568 neuronas) - Dataset de Imágenes de Alemania}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
			...
			\item \underline{Dataset del Perú}
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño C (29'877 620 neuronas) - Dataset de Imágenes de Perú}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
		...
		\subsubsection{Diseño D} %model6
			...
			\item \underline{Dataset de Alemania}		
				...
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño D (4'166 944 neuronas) - Dataset de Imágenes de Alemania}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
			...
			\item \underline{Dataset del Perú}
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño D (30'106 996 neuronas) - Dataset de Imágenes de Perú}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
		...
		\vspace{-1em}
			...
			\item \underline{Dataset de Alemania}		
				...
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño E (2'077 706 neuronas) - Dataset de Imágenes de Alemania}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline

				 & 1 de 32 x 32  & Conv(DropOut : 0.8) & 32 de 3 x 3 neuronas & Activo & 32 de 32 x 32  & --\\ 
				\multirow{-2}{*}{1} &  32 de 32 x 32  &  Max Pool &  32 de 2 x 2 &  Inactivo & 32 de 16 x 16  & {\cellcolor[HTML]{DAE8FC}(Kernel = 8) 32 de 2x2}\\ \hline
				 & 32 de 16 x 16  & Conv(DropOut : 0.7) & 64 de 5 x 5 neuronas & Activo & 64 de 16 x 16  & --\\ 
			...
			\item \underline{Dataset del Perú}
				...
				\begin{table}[H]
				\begin{center}
				\caption{\small{Diseño E (6'088 304 neuronas) - Dataset de Imágenes de Perú}}
				\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c>{\scriptsize}c|>{\scriptsize}c|}
				\hline
				{\color[HTML]{000000} \textbf{Capa}} & {\color[HTML]{000000} \textbf{Entrada}} & {\color[HTML]{000000} \textbf{Tipo}} & {\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Número de\\ (kernels/filtros)\end{tabular}}} & {\color[HTML]{000000} \textbf{Padding}} & {\textbf{Salida}} & {\textbf{Func.Esc.Múltiple}}\\ \hline
			...
			En el apéndice A se muestran bloques de pseudocódigo que fueron usando para la construcción de todos los diseños de red mostrados anteriormente.
		%------------------------------------------------------------------------------------------------------------------------------------------------------------
%\newpage
