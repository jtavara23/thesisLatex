...
\section{Variables de la Investigación}
	...
	\section{Indicadores}
		...
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Tasa de Sensibilidad\\ (Efectividad)\end{tabular}} & \multirow{2}{*}{$S= \frac{Verdaderos\,Positivos}{{Verdaderos\,Positivos}+{Falsos\,Negativos}}x100$} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Modelo de\\ Reconocimiento\end{tabular}} \\
		 &  &  \\ \hline
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Tasa de Error \\ (Especificidad)\end{tabular}} & \multirow{2}{*}{$S= \frac{Falsos\,Negativos}{{Verdaderos\,Positivos}+{Falsos\,Negativos}}x100$} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Modelo de\\ Reconocimiento\end{tabular}} \\
		 &  &  \\ \hline
		...
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}El espacio ROC \\ (Curvas ROC)\end{tabular}} & \multirow{2}{*}{Relación entre efectividad y especificidad} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Modelo de\\ Reconocimiento\end{tabular}} \\
		 &  &  \\ \hline
		\end{tabular}
		\vspace{-1.0em}
		\end{table}
